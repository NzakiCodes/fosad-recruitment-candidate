      ...
      <div>
        ...
        <div>
          ...
          <div className=" px-6 py-4 flex">
            <div className="mr-3"><Checkbox type="squared" size="small" color="primary" checked={false}/></div>
            
           <p className="text-[#63748A] font-medium text-[16px]">Currently in progress</p>
          </div>
