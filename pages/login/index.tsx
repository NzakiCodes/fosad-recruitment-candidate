  ...
  return (
    <div className="relative">
      <div className="py-8 lg:py-4 px-5 mx-auto max-w-xl lg:h-screen mb-32">
        <div className="my-auto py-20  h-full w-full">
          <div className="w-full text-center my-10">
            <h2 className="font-bold text-3xl text-secondary">Login ✨</h2>
          </div>
          <div className="lg:w-full lg:mx-5 text-center">
            <div>
              <input
                type="email"
             ...
             <Button label="Login" cl="text-white text-lg py-5"/>
             </div>
